...
export default function MastermindShowcase({
  ...
  const css = [
    ...
    `    justify-content:flex-start;align-items:center;padding:0 30px;text-align:center`,
    `  }`,
    // 信息 Swiper 桌面端也撑满父容器
    ...
    `  }`,
    `  #${scopeId} .mm-info-card{`,
    `    display:flex;flex-direction:column;align-items:center;justify-content:flex-start;width:100%;text-align:center`,
    `  }`,
    `  #${scopeId} .mm-text-group{display:flex;flex-direction:column;align-items:center;width:100%}`,
